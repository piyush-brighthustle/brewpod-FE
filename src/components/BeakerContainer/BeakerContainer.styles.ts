...
export const styles = StyleSheet.create({
  beakerContainer: { display: 'flex', flex: 1, justifyContent: 'center', flexDirection: 'row', marginTop: scaleMargin(10), position: 'relative' },
  ...
  gearContainer: { position: 'absolute', top: 250 },
});
